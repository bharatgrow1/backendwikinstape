...
class EkoRechargeService:
    ...
    def recharge(self, mobile, amount, operator_id, client_ref_id, circle=None):
        """Perform recharge or bill payment"""
...
class RechargeManager:
    def __init__(self):
        self.eko_service = EkoRechargeService()
    ...
    def perform_recharge(self, mobile, amount, operator_id, user=None, circle=None):
        ...
        # Make API call
        response = self.eko_service.recharge(
            mobile=mobile,
            amount=amount,
            operator_id=operator_id,
            client_ref_id=client_ref_id,
        ...
        if isinstance(response, dict):
            ...
            if response_status == 0:
                ...
                failure_message = "Recharge Failed"
            
            result["success"] = is_success
            result["message"] = failure_message if not is_success else "Recharge successful"
