...
from recharge.models import RechargeServiceCharge, Operator
from django.conf import settings

class Command(BaseCommand):
    help = 'Initialize recharge service charges'
    ...
    def handle(self, *args, **options):
        ...
        for charge_data in service_charges:
            charge, created = RechargeServiceCharge.objects.update_or_create(
        ...
        self.stdout.write(
            self.style.SUCCESS('Successfully initialized recharge data')
        )